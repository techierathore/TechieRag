...
public sealed class AppDbOptions
{
    ...
    /// <summary>
    /// Provider name. <c>Sqlite</c> is the only supported value since the 2026-07-26
    /// BRD-102 amendment (REQ-FN-029). The setting is retained purely so a stale
    /// <c>Postgres</c> value is rejected loudly rather than ignored.
    /// </summary>
