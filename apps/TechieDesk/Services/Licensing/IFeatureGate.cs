...
/// Mirrors the role-gating pattern of <c>ICapabilityService</c> but for license-tier features.
/// In offline single-user mode it resolves against the local Free tier; when the license grace
