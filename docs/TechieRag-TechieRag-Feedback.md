...
### TR-RAG-037 — `EmailConnector` item identity embeds the **archive's file name**, so relocating an `.mbox` re-ingests the entire archive (major, found 2026-07-29 during `*build-phase`)
